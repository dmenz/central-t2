...
class CustomAuthToken(ObtainAuthToken):
    ...
    @swagger_auto_schema(
        ...
        operation_description="Retorna o username do usuário ou apenas visitante se o usuário não estiver logado",
        security=[{'Token':[]}],
        manual_parameters=[
            openapi.Parameter(
                'Authorization',
    ...
    def delete(self, request):
        try:
            ...
            return Response({'msg': 'Token não existe.'}, 
    ...
    def put(self, request):
        ...
        if user.check_password(oldPassword):
            ...
            try:
                ...
                return Response(
                    {'error': "Erro desconhecido - isso não deveria ter acontecido"},
